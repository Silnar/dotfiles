...
if has("nvim")
  let g:rc#dirPath="~/.config/nvim/"
  let g:rc#initFile="~/.config/nvim/init.vim"
else
  let g:rc#dirPath="~/.vim/"
  let g:rc#initFile="~/.vimrc"
endif
" }}}

" Load helper functions {{{
execute "source " . g:rc#dirPath . "rc/functions.rc.vim"
" }}}
...
if ! isdirectory(expand(g:rc#dirPath . 'bundle'))
  echon "Installing neobundle.vim..."
  silent call mkdir(expand(g:rc#dirPath . 'bundle'), 'p')
  execute "silent !git clone https://github.com/Shougo/neobundle.vim " . expand(g:rc#dirPath . 'bundle/neobundle.vim')
  echo "done."
  if v:shell_error
...
if has('vim_starting')
  ...
  let &runtimepath=&runtimepath . ',' . g:rc#dirPath . "bundle/neobundle.vim/"
endif
" }}}

" Load bundles {{{
call neobundle#begin(expand(g:rc#dirPath . 'bundle/'))

  if neobundle#load_cache()
    NeoBundleFetch 'Shougo/neobundle.vim'

    execute "NeoBundleLocal " . g:rc#dirPath . "bundle-local/"

    for file in split(globpath(g:rc#dirPath . 'rc/plugins/', '*.plugin.def.vim'), '\n')
...
execute "source " . g:rc#dirPath . "rc/defaults.rc.vim"
" }}}
...
for file in split(globpath(g:rc#dirPath . 'rc/plugins/', '*.plugin.rc.vim'), '\n')
...
nmap <silent> <Leader>. :<C-u>execute "edit " . g:rc#initFile<CR>
nmap <silent> <Leader>> :<C-u>execute "source " . g:rc#initFile<CR>
